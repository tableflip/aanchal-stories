...
const CallBackForm = () => (
  <form className='pa3 black-80' method='post' action='https://post.tableflip.io/test.aanchal.org.uk'>
    <div className='measure-narrow'>
      ...
      <input autoFocus className='input-reset ba b--black-20 pa3 mb2 db w-100 f4 courier' type='tel' id='phone-number' name='phone-number' aria-describedby='phone-number-desc' />
